...
namespace praas::process {
  ...
  Options opts(int argc, char ** argv)
  {
    ...
    options.add_options()
      ...
      ("hole-puncher-address", "IP address of hole puncher.",  cxxopts::value<std::string>())
    ...
    result.hole_puncher_address = parsed_options["hole-puncher-address"].as<std::string>();
    result.max_sessions = parsed_options["max-sessions"].as<int>();
